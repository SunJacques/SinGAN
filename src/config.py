...
def get_arguments():
    ...
    parser.add_argument('--niter', type=int, default=8000, help='number of epochs to train per scale')
    ...
    parser.add_argument('--alpha',type=float, help='reconstruction loss weight',default=11)
